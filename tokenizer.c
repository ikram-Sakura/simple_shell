...
/**
 * **_split_w - splits a string into words
 * @str: the input string
 * @d: the delimeter
 * Return: a pointer to an array of strings, or NULL on failure
 */
char **_split_w(char *str, char d)
{
	int i, j, k, m, words = 0;
	char **s;
...
/**
 * **split_w - splits a string into words. Repeat delimiters are ignored
 * @str: the input string
 * @d: the delimeter string
 * Return: a pointer to an array of strings, or NULL on failure
 */

char **split_w(char *str, char *d)
{
	int i, j, k, m, words = 0;
	char **s;
